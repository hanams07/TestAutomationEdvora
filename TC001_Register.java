...
public class TC001_Register {
	...
	public static void main(String[] args) throws InterruptedException{
		...
		//Launch the website
		wd.get("https://testing-assessment-foh15kew9-edvora.vercel.app/r");
		Thread.sleep(10000);
		...
		//Type xpath to click button Create Account
		...
		System.out.println("Successfully register the website");
